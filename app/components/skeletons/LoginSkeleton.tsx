  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-transparent text-slate-100">
      ...
      <section className="relative mx-auto flex min-h-screen w-full max-w-5xl items-center justify-center px-4 py-8 sm:px-6 sm:py-12">
        <div className="w-full max-w-sm rounded-3xl border border-zinc-700/50 bg-zinc-900/55 p-6 shadow-2xl shadow-black/40 backdrop-blur-xl sm:max-w-md sm:p-10">
