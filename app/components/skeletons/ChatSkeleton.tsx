...
export function SkeletonChatHeader() {
  return (
    <header className="relative z-10 flex items-center justify-between border-b border-zinc-800 bg-zinc-950/55 p-3 backdrop-blur-md sm:p-4">
...
export function SkeletonChatMessages() {
  return (
    <main className="custom-scrollbar relative z-10 flex-1 space-y-4 overflow-y-auto bg-zinc-950/15 p-3 sm:p-4">
...
export function SkeletonChatInput() {
  return (
    <footer className="relative z-10 p-3 sm:p-4">
      <div className="flex items-center gap-2 rounded-2xl border border-zinc-800 bg-zinc-900/90 p-2 backdrop-blur-sm">
