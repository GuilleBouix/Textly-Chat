...
export function SkeletonSidebar() {
  return (
    <aside className="flex h-full w-80 flex-col border-r border-zinc-800/80 bg-zinc-950/72 backdrop-blur-md">
      <div className="flex items-center gap-3 border-b border-zinc-800/70 bg-zinc-900/35 p-5">
...
export function SkeletonChat() {
  return (
    <section className="relative flex min-w-0 flex-1 flex-col bg-transparent">
      ...
      <header className="relative z-10 flex items-center gap-3 border-b border-zinc-800 bg-zinc-950/55 p-4 backdrop-blur-md">
        <Skeleton className="h-10 w-10 rounded-full" />
        <div>
      ...
      <main className="relative z-10 flex-1 bg-zinc-950/15 p-4">
